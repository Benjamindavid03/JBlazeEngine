...
public class AnimatedModel {
     ...
     * includes vertex positions, normals, texture coords, IDs of joints that
     * affect each vertex, and their corresponding weights.
     * @param texture - the diffuse texture for the entity.
     * @param rootJoint - the root joint of the joint hierarchy which makes up
     * the "skeleton" of the entity.
     * @param jointCount - the number of joints in the joint hierarchy
     * (skeleton) for this entity.
     *
     */
     ...
     * and every other joint in the skeleton is a descendant of this joint.
     */
...
//		animator.update();
     ...
     * method also adds the transforms of all the descendents of this joint too.
     * @param jointMatrices - the array of joint transforms that is being
     * filled.
     */
